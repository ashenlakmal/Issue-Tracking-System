...
<script lang="ts">
    ...
    // State variables for the login form using Svelte 5 syntax
    let email = $state('');
    let password = $state('');
...
<div class="flex min-h-screen bg-white font-sans">
    ...
    <div class="relative hidden items-center justify-center overflow-hidden bg-slate-950 lg:flex lg:w-1/2">
        ...
        <div class="relative z-10 max-w-xl p-12 text-white">
            <div class="mb-8 flex items-center space-x-3">
                <!-- Logo -->
                <svg class="h-10 w-10 text-[#ff3e00]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 class="mb-6 text-5xl leading-tight font-bold tracking-tight text-slate-100">
                ...
                <span class="bg-gradient-to-r from-[#ff3e00] to-orange-400 bg-clip-text text-transparent">clarity.</span>
            </h2>
            <p class="mb-8 text-lg leading-relaxed font-medium text-slate-400">
                The enterprise-grade issue tracking system designed for high-performing software engineering teams.
            </p>
    ...
    <div class="relative flex w-full flex-col justify-center bg-white px-8 sm:px-16 lg:w-1/2 lg:px-24 xl:px-32">
        ...
        <div class="mb-10 flex items-center space-x-2 lg:hidden">
            <svg class="h-8 w-8 text-[#ff3e00]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
            </svg>
            <span class="text-2xl font-extrabold text-gray-900 uppercase">Tracker<span class="text-[#ff3e00]">Pro</span></span>
        </div>
        ...
        <div class="mx-auto w-full max-w-md lg:mx-0">
            ...
            <!-- Form with SvelteKit enhance to handle submission and Redirect -->
            <form 
                method="POST" 
                class="space-y-6"
                use:enhance={() => {
            ...
            >
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-semibold text-[#ff3e00] transition duration-150 hover:text-[#cc3100]">
                            Forgot password?
                        </a>
                    </div>
                </div>
            ...
            <p class="mt-8 text-center text-sm font-medium text-gray-600">
                ...
                <a href="/register" class="font-bold text-[#ff3e00] transition duration-150 hover:text-[#cc3100]">
                    Create an account
                </a>
            </p>
        </div>
